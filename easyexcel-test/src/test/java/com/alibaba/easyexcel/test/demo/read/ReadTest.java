...
public class ReadTest {
  ...
  public void simpleRead() {
    ...
    String fileName = TestFileUtil.getPath() + "demo" + File.separator + "role" + File.separator + "demo.csv";
    ...
    List<DemoData> demoDataList = demoDataListener.cachedDataList;

    System.out.println(demoDataList);
  }

  @Test
  public void simpleRoleEmployeeRead() {

    String fileName = TestFileUtil.getPath() + "demo" + File.separator + "role" + File.separator + "test.xlsx";
    RoleRelationEmployeeListener demoDataListener = new RoleRelationEmployeeListener();
    // 这里 需要指定读用哪个class去读，然后读取第一个sheet 文件流会自动关闭
    EasyExcel.read(fileName, RoleRelationEmployeeVo.class, demoDataListener).sheet().doRead();

    List<RoleRelationEmployeeVo> demoDataList = demoDataListener.cachedDataList;
