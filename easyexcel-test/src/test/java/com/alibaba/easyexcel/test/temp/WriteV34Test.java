...
import com.alibaba.easyexcel.test.demo.write.DemoExportData;
...
public class WriteV34Test {
    ...
    public void test() throws Exception {
        ...
        EasyExcel.write(fileName, DemoExportData.class).head(head()).registerWriteHandler(horizontalCellStyleStrategy).sheet(
                "模板")
            .doWrite(data(1));
    }
    ...
    private List<DemoExportData> data(int no) {
        List<DemoExportData> list = new ArrayList<DemoExportData>();
        for (int i = 0; i < 10; i++) {
